...
class  Detection:
    def __init__(self,root,isTKroot = True):
        ...
        def Statistics(num):
            ...
            Label_9_Ft=tkinter.font.Font(family='华文新魏', size=15,weight='normal',slant='roman',underline=0,overstrike=0)
            ...
            Label_10_Ft=tkinter.font.Font(family='华文新魏', size=15,weight='normal',slant='roman',underline=0,overstrike=0)
            ...
            Label_12_Ft=tkinter.font.Font(family='华文新魏', size=15,weight='normal',slant='roman',underline=0,overstrike=0)
            ...
            Label_13_Ft=tkinter.font.Font(family='华文新魏', size=12,weight='normal',slant='roman',underline=0,overstrike=0)
